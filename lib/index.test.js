...
describe("openPRRefNames", () => {
  ...
  test.skip("Set with five branches", async () => {
      ...
      edges: [
        {
          node: {
            ...
            commits: { edges: [{ node: { commit: { oid: "55733833323b" } } }] }
          }
        },
        {
          node: {
            headRefName: "branch2",
            commits: { edges: [{ node: { commit: { oid: "55523b" } } }] }
          }
        },
        {
          node: {
            headRefName: "Gulp",
            commits: { edges: [{ node: { commit: { oid: "556623b" } } }] }
          }
        },
        {
          node: {
            headRefName: "palmTrees",
            commits: {
              edges: [{ node: { commit: { oid: "552727288fbccc23b" } } }]
            }
          }
        },
        {
          node: {
            headRefName: "phone",
            commits: { edges: [{ node: { commit: { oid: "cccccc23b" } } }] }
          }
        }
      ]
    };
      ...
      pullRequests.edges.map(edge => ({
        ...
        commits: {
          edges: [
            {
              node: {
                commit: { oid: edge.node.commits.edges[0].node.commit.oid }
              }
            }
          ]
        }
